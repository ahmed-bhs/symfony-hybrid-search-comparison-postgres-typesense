 ...
 *             distance?: value-of<\Symfony\AI\Store\Bridge\Postgres\Distance>|\Symfony\AI\Store\Bridge\Postgres\Distance|Param, // Distance metric to use for vector similarity search // Default: "l2"
 *             dbal_connection?: string|Param,
 *             hybrid?: bool|array{ // Enable hybrid search combining pgvector (semantic) and Full-Text Search (lexical) using RRF
 *                 enabled?: bool|Param, // Default: false
 *                 content_field?: string|Param, // Default: "content"
 *                 semantic_ratio?: float|Param, // Ratio between semantic (vector) and keyword (FTS) search. 0.0 = pure FTS, 0.5 = balanced, 1.0 = pure semantic // Default: 1.0
 *                 language?: string|Param, // PostgreSQL text search configuration (e.g., "simple", "english", "french"). Default: "simple" (multilingual) // Default: "simple"
 *                 text_search_strategy?: string|Param, // Text search strategy: "native" for PostgreSQL FTS (ts_rank_cd) or "bm25" for BM25 ranking (requires plpgsql_bm25 extension) // Default: "native"
 *                 bm25_language?: string|Param, // BM25 language code for stemming (e.g., "en", "fr", "es", "de", "it", "pt", "nl", "ru", "ar", "zh"). Default: "en" // Default: "en"
 *                 rrf_k?: int|Param, // RRF (Reciprocal Rank Fusion) constant. Higher = more equal weighting. Default: 60 // Default: 60
 ...
 * }
 * @psalm-type AcseoTypesenseConfig = array{
 *     typesense?: array{ // Typesense server information
 *         url: scalar|null|Param,
 *         key: scalar|null|Param,
 *         collection_prefix?: scalar|null|Param,
 *     },
 *     collections?: array<string, array{ // Default: []
 *         collection_name?: scalar|null|Param,
 *         enable_nested_fields?: bool|Param,
 *         entity?: scalar|null|Param,
 *         fields?: list<array{ // Default: []
 *             entity_attribute?: scalar|null|Param,
 *             name?: scalar|null|Param,
 *             type?: scalar|null|Param,
 *             facet?: bool|Param,
 *             infix?: bool|Param,
 ...
 *             },
 *         }>,
 *         default_sorting_field: scalar|null|Param,
 *         finders?: array<string, array{ // Default: []
 *             finder_service?: scalar|null|Param,
 *             finder_parameters?: list<scalar|null|Param>,
 *         }>,
 ...
 *     twig?: TwigConfig,
 *     acseo_typesense?: AcseoTypesenseConfig,
 *     "when@dev"?: array{
 *         imports?: ImportsConfig,
 *         parameters?: ParametersConfig,
 *         services?: ServicesConfig,
